  ...
  <section class="settle-manager">
        ...
        <el-row>
          ...
          <el-col :xs="24" :sm="24" :md="24" :lg="12">
            <el-form-item label-width="80px" label="创建时间" class="postInfo-container-item">
              <el-date-picker v-model="filters.createTime" type="datetimerange" :picker-options="pickerOptions2"
                placeholder="选择时间范围" align="right">
              </el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="24" :lg="12">
            <el-form-item label-width="80px" label="更新时间" class="postInfo-container-item">
              <el-date-picker v-model="filters.updateTime" type="datetimerange" :picker-options="pickerOptions2"
                placeholder="选择时间范围" align="right">
              </el-date-picker>
            </el-form-item>
          </el-col>
      ...
      <div class="panel-body">
        ...
        <el-col :span="24" class="pag">
          ...
          <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
            :current-page.sync="listQuery.curPage" :page-sizes="[10,20,30, 50]" :page-size="listQuery.pageSize"
            layout="total, sizes, prev, pager, next, jumper" :total="total" class="fr">
          </el-pagination>
        </el-col>
      </div>
    </div>
    ...
    <el-dialog title="编辑维护项" :visible.sync="editFormVisible" :close-on-click-modal="false">
      <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
        ...
        <el-form-item label="维护内容" prop="strContent" style="width: 450px;">
          <el-input type="textarea" :rows="2" placeholder="请输入内容" v-model="editForm.strContent">
          </el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="新增维护项" :visible.sync="addFormVisible" :close-on-click-modal="false" size="small">
      <el-form ref="addForm" :model="addForm" label-width="80px" :rules="addFormRules">
        ...
        <!--</el-row>-->
        <el-form-item label="维护内容" prop="strContent" style="width: 450px;">
          <el-input type="textarea" :rows="2" placeholder="请输入内容" v-model="addForm.strContent">
          </el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
